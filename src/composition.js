...
const RedisEventBus              =
require('./infrastructure/RedisEventBus');
const SqlAppointmentRepository   =
require('./infrastructure/SqlAppointmentRepository');
const SqlPatientRepository       =
require('./infrastructure/SqlPatientRepository');
const TwilioNotificationService  =
require('./infrastructure/TwilioNotificationService');
const SqlBillingRepository       =
require('./infrastructure/SqlBillingRepository');
const SqlAuditRepository         =
require('./infrastructure/SqlAuditRepository');

// Core
const AppointmentService   = require('./core/services/AppointmentService');
const NotificationConsumer =
require('./core/consumers/NotificationConsumer');
...
eventBus.subscribe('ConsultaAgendada', (e) =>
notificationConsumer.handle(e));
